	...
	MMDLoader.prototype = Object.assign(Object.create(THREE.Loader.prototype), {
		...
		load: function (url, onLoad, onProgress, onError) {
			...
			if (this.resourcePath !== '') {
				...
				console.log('resourcePath_1', resourcePath);


			} else if (this.path !== '') {

				resourcePath = this.path;
				console.log('resourcePath_2', resourcePath);

			} else {

				resourcePath = THREE.LoaderUtils.extractUrlBase(url);
				console.log('resourcePath_3', resourcePath);
		...
		loadPMX: function (url, onLoad, onProgress, onError) {
			...
			this.loader
				...
				.load(url, function (buffer) {
					...
					console.log('parser.parsePmx(buffer, true)', parser.parsePmx(buffer, true));
